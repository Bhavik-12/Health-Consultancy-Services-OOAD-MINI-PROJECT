...
<title>Home Page | Health Consultancy Services</title>
			...
			<div class="col-md-8 p-5">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="card my-card">
							<div class="card-body">
								...
								<p>Get your health queries/issues resolved Online 
								   through our network of health experts.</p>
							</div>
						</div>
					</div>
						...
						<div class="card my-card">
							<div class="card-body">
								...
								<p>Leveraging its vast medical expertise & technological
									advantage,Our network of health experts have consistently 
									delivered best in class clinical outcomes.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 mt-2">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 myP-color">Full time Availability</p>
								<p>Health Consultancy Portal provides its Customers/Users
								   service 24x7 and helps in dealing with emergency
								   situations. </p>
							</div>
						</div>
					</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Puneeth </p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Abhay Kp</p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Keerthi</p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Niharika</p>
